  ...
  return (
    <div className="flex flex-col min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100">
      ...
      <section className="relative overflow-hidden py-16 px-6 md:py-24 max-w-6xl mx-auto text-center w-full">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#eab308]/10 rounded-full blur-3xl pointer-events-none -z-10" />

        {/* SmartOS Internal Badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-[#eab308]/10 text-[#eab308] dark:text-[#eab308] border border-[#eab308]/20 mb-6">
          <ShieldCheck className="w-4 h-4" />
          <span>SmartOS Internal Documentation Portal</span>
        </div>

        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">
          SmartOS <span className="text-[#eab308] underline decoration-[#eab308]/40 decoration-wavy underline-offset-8">Technical Docs</span>
        </h1>
        ...
        <div className="flex justify-center">
          <Link
            href="/docs"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-medium bg-[#eab308] hover:bg-[#eab308]/90 text-neutral-950 shadow-md hover:shadow-[#eab308]/20 transition-all duration-200"
          >
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="group relative rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-8 shadow-sm hover:shadow-xl hover:border-[#eab308]/50 transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-xl bg-[#eab308]/10 text-[#eab308] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <Key className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-neutral-900 dark:text-neutral-100 flex items-center gap-2">
                Access Management Module
                <span className="text-xs px-2 py-0.5 rounded bg-[#eab308]/10 text-[#eab308] dark:text-[#eab308] border border-[#eab308]/20 font-normal">New</span>
              </h3>
              ...
              <div className="space-y-2 mb-8">
                <div className="flex items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                  <Cpu className="w-4 h-4 text-[#eab308] shrink-0" />
            ...
            <Link
              href="/docs"
              className="inline-flex items-center justify-between w-full px-4 py-2.5 rounded-lg bg-neutral-100 dark:bg-neutral-800 group-hover:bg-[#eab308] group-hover:text-neutral-950 text-sm font-semibold transition-colors duration-200"
            >
          ...
          <div className="group relative rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-8 shadow-sm hover:shadow-xl hover:border-[#eab308]/50 transition-all duration-300 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-2 mb-8">
                <div className="flex items-center gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                  <FileText className="w-4 h-4 text-[#eab308] shrink-0" />
      ...
      <section className="py-12 px-6 max-w-6xl mx-auto w-full border-t border-neutral-200 dark:border-neutral-800 mt-8 mb-12">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <Link
            href="/docs"
            className="p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 hover:border-[#eab308]/40 transition-colors group"
          >
            <div className="font-semibold text-sm mb-1 group-hover:text-[#eab308] transition-colors">
